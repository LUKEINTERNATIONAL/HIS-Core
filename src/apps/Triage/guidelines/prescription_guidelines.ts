/**
 * QUICK FACTS ABOUT Triage REGIMENS (Malawi Clinical HIV Guidelines 2018 Version 1)
 *  - Triage regimens are grouped into first and secondline
        ...
        actions: {
            alert: async () => {
                const action = await listActionSheet(
                    ...
                    '',
                    [
                        "Children under 3 years often have a high viral load and may be infected with drug-resistant HIV from previous exposure to ARVs (mother's Triage and/or infant nevirapine prophylaxis)",
